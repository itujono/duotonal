...
if(isset($_POST['submit'])){
    $email = $_POST['email'];
    $status = 1;
    $query = $mysqli->query("INSERT INTO default_subscribe (emailSUBSCRIBE, statusSUBSCRIBE) VALUES ('$email','$status')");
}
?>
<!doctype html>
<html class="no-js" lang="">
    ...
    <body id="style6">
        ...
        <main id="player" class="player"
            data-property="{
                videoURL:'http://youtu.be/--aHImL98Nc',
                containment:'self',
                autoPlay:true,
                mute:false,
                opacity:1
        ...
        <section class="content-section" id="subscribe">
            ...
            <div class="wrapper">
                ...
                <div class="subscribe-form-wrapper">
                    <form action="index6.php" method="post" id="subscribe-form" name="subscribe-form">
                        ...
                        <div class="subscribe-form-inner">
                            ...
                            <div class="subscribe-form-submit">
                                <button type="submit" name="submit" name="submit" id="subscribe-form-submit"><i class="mdi mdi-rss"></i>Subscribe</button>
                            </div>
                        </div>
                    </form>
